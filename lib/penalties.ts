...
type PenFields = Pick<MatchInfo, "status" | "round" | "homeScore" | "awayScore" | "winner" | "homePens" | "awayPens">;
...
export function decidedOnPens(m: PenFields): boolean {
  ...
  return m.winner != null && m.homeScore != null && m.awayScore != null && m.homeScore === m.awayScore;
}
...
export function pensScore(m: Pick<MatchInfo, "homePens" | "awayPens">): { home: number; away: number } | null {
...
export function pensWinnerSide(m: Pick<MatchInfo, "homePens" | "awayPens">): "home" | "away" | null {
