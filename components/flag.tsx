...
export function Flag({
  ...
  if (!iso) {
    return (
      <span
        className="inline-block shrink-0 rounded-[2px] bg-muted/60 ring-1 ring-border"
  ...
  return (
    <span
      className={`fi fi-${iso} inline-block shrink-0 rounded-[2px] bg-cover bg-center ring-1 ring-border/50`}
