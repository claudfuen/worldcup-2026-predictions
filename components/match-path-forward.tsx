...
export async function MatchPathForward({
  m,
  matches,
}: {
  m: MatchInfo
  ...
  return (
    <section className="mt-8">
      ...
      <p className="mt-2 text-xs text-pretty text-muted-2">{lede}</p>
    </section>
  )
}
