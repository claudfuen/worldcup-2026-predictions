...
export function PlayerAvatar({
  ...
  return (
    ...
    >
      <div className="size-full overflow-hidden rounded-2xl border border-border bg-gradient-to-b from-muted/70 to-card dark:inset-ring dark:inset-ring-white/5">
        {showImg ? (
      ...
      <span className="absolute -right-1 -bottom-1 inline-flex rounded-md ring-2 ring-card">
