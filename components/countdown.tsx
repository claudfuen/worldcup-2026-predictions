...
export function Countdown({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 font-mono text-xs font-semibold text-foreground/80 ${className}`}
    ...
    >
      ...
      {label && <span className="font-normal text-muted-2">{label}</span>}
    </span>
  )
}
