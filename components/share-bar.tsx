...
export function ShareBar({ text, path }: { text: string; path: string }) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <a href={x} target="_blank" rel="noopener noreferrer" className={btn} aria-label="Share on X" title="Share on X">
      ...
      <a href={wa} target="_blank" rel="noopener noreferrer" className={btn} aria-label="Share on WhatsApp" title="Share on WhatsApp">
