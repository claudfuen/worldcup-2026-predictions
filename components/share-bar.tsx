...
export function ShareBar({
  ...
  const btn =
    "border-border bg-card text-muted-foreground hover:border-primary/40 hover:text-foreground inline-flex size-10 items-center justify-center rounded-md border sm:size-8"

  return (
    <div className="flex items-center gap-1.5">
      {!compact && (
        <span className="me-1 font-mono text-[10px] font-semibold tracking-wide text-muted-foreground uppercase">
          {t("share.label")}
        </span>
      )}
      <a
      ...
      <button
        ...
        data-channel="copy"
        data-path={path}
        className={`${btn} ${copied ? "border-win/40 text-win" : ""}`}
      ...
      >
        {copied ? (
          ...
          <svg
            ...
            aria-hidden
          >
            <path d="M10 13a5 5 0 0 0 7.07 0l1.5-1.5a5 5 0 0 0-7.07-7.07L11 5" />
            <path d="M14 11a5 5 0 0 0-7.07 0l-1.5 1.5a5 5 0 0 0 7.07 7.07L13 19" />
          </svg>
        )}
      </button>
    </div>
