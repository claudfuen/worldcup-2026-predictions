...
describe("relativeDay", () => {
  ...
  it("evening match today → tonight", () => {
    ...
    expect(relativeDay("2026-07-01T01:00:00Z", ET, NOW)).toEqual({
      key: "tonight",
    })
  })
  ...
  it("1 AM kickoff is still TONIGHT, not tomorrow (05:00 rollover)", () => {
    ...
    expect(relativeDay("2026-07-01T05:00:00Z", ET, NOW)).toEqual({
      key: "tonight",
    })
  })
  ...
  it("4:59 AM is still tonight; 5:00 AM has rolled over to a new day", () => {
    ...
    expect(relativeDay("2026-07-01T08:30:00Z", ET, NOW)).toEqual({
      key: "tonight",
    })
    // 06:00 EDT Jul 1 → that's tomorrow morning (past the rollover), daytime → tomorrow
    expect(relativeDay("2026-07-01T10:00:00Z", ET, NOW)).toEqual({
      key: "tomorrow",
    })
  })
  ...
  it("tomorrow afternoon → tomorrow", () => {
    ...
    expect(relativeDay("2026-07-01T17:00:00Z", ET, NOW)).toEqual({
      key: "tomorrow",
    })
  })
  ...
  it("yesterday → yesterday", () => {
    ...
    expect(relativeDay("2026-06-29T17:00:00Z", ET, NOW)).toEqual({
      key: "yesterday",
    })
  })
  ...
  it("later this week → localized weekday", () => {
    ...
    expect(relativeDay("2026-07-03T17:00:00Z", ET, NOW)).toEqual({
      text: "Friday",
    })
  })
  ...
  it("beyond a week → month + day", () => {
    ...
    expect(relativeDay("2026-07-10T17:00:00Z", ET, NOW)).toEqual({
      text: "Jul 10",
    })
  })
