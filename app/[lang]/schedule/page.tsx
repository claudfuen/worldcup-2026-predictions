...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: localeHref(locale, "/schedule"),
      type: "website",
    },
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <RelatedLinks
        links={[
          {
            label: t("schedule.relatedGroups"),
            href: localeHref(locale, "/groups"),
          },
          {
            label: t("schedule.relatedBracket"),
            href: localeHref(locale, "/bracket"),
            hint: t("schedule.relatedBracketHint"),
          },
          {
            label: t("schedule.relatedOverview"),
            href: localeHref(locale, "/"),
            hint: t("schedule.relatedOverviewHint"),
          },
        ]}
      />
    </main>
