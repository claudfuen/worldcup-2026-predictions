...
import { flagDataUri, OG_SIZE, OG_CONTENT_TYPE, OG_BG, OG_FG, OG_GREEN, OG_GOLD, OG_MUTED } from "@/lib/og";

// Dynamic per-venue social card: the FIFA host-city name + the original (commercial) name, host city/country
// with flag, capacity and how many matches it hosts — flagged gold when it hosts the Final.
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const flag = await flagDataUri(v.hostCode);
