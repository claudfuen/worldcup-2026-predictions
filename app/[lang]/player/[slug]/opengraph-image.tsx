...
export default async function Image({
  ...
  const [flag, headshot] = await Promise.all([
    ...
    imgDataUri(
      await getPlayerImage(view.player, view.teamCode).catch(() => null)
    ),
  ])
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
            ...
            {bootLine && (
              <div
                style={{
                  display: "flex",
                  fontSize: 27,
                  color: gb?.clinched ? OG_GOLD : OG_GREEN,
                  fontWeight: 600,
                  marginTop: 18,
                }}
              >
        ...
        {headshot && (
          <img src={headshot} style={{ height: 330, objectFit: "contain" }} />
        )}
      </div>
