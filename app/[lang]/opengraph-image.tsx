...
export const alt =
  "World Cup 2026 Predictions — live title odds, bracket and champion probabilities"
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: "64px 72px",
        background:
          "linear-gradient(135deg, #0a0f0b 0%, #0d1410 55%, #102417 100%)",
        color: "#f7faf8",
    ...
    >
          ...
          {teams.map((t, i) => (
            <div
              ...
              style={{
                display: "flex",
                alignItems: "center",
                marginBottom: i === teams.length - 1 ? 0 : 16,
              }}
            >
              <div
                style={{
              ...
              >
                <div
                  style={{
                    display: "flex",
                    width: `${Math.round((t.title / maxTitle) * 100)}%`,
                    height: 10,
                    borderRadius: 6,
                    background: GREEN,
                  }}
      ...
      >
        <div style={{ display: "flex", color: "#8aa394" }}>
