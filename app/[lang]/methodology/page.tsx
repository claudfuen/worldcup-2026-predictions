...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: localeHref(locale, "/methodology"),
      type: "article",
    },
...
export default async function MethodologyPage() {
  ...
  const FAQ: { q: string; a: string }[] = [
    {
      q: t("methodology.faq.calculatedQ"),
      a: t("methodology.faq.calculatedA"),
    },
    { q: t("methodology.faq.accurateQ"), a: t("methodology.faq.accurateA") },
    { q: t("methodology.faq.thirdQ"), a: t("methodology.faq.thirdA") },
    {
      q: t("methodology.faq.tiebreakersQ"),
      a: t("methodology.faq.tiebreakersA"),
    },
    {
      q: t("methodology.faq.guaranteedQ"),
      a: t("methodology.faq.guaranteedA"),
    },
  ]
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <header>
        ...
        <p
          className="mt-3 text-base text-pretty text-muted-foreground"
          dangerouslySetInnerHTML={{ __html: t("methodology.intro") }}
        />
      </header>
      <div className="mt-8 space-y-7 text-sm leading-relaxed">
        <Section
          title={t("methodology.sections.ratingsTitle")}
          body={t("methodology.sections.ratingsBody")}
        />
        <Section
          title={t("methodology.sections.matchTitle")}
          body={t("methodology.sections.matchBody")}
        />
        <Section
          title={t("methodology.sections.simTitle")}
          body={t("methodology.sections.simBody")}
        />
        <Section
          title={t("methodology.sections.thirdTitle")}
          body={t("methodology.sections.thirdBody")}
        />
        <Section
          title={t("methodology.sections.certaintyTitle")}
          body={t("methodology.sections.certaintyBody")}
        />
        <Section
          title={t("methodology.sections.dataTitle")}
          body={t("methodology.sections.dataBody")}
        />
      </div>

      <section className="mt-12">
        <h2 className="text-xl font-semibold tracking-tight">
          {t("methodology.faqHeading")}
        </h2>
